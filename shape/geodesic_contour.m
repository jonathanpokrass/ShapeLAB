...
d3_2 = d3 - d2;
d3_2(d3_2 == 0) = 0.0000001;

d3_1 = d3 - d1;
d3_1(d3_1 == 0) = 0.0000001;

d2_1 = d2 - d1;
d2_1(d2_1 == 0) = 0.0000001;

lambda1 = 1-(th-d1)./(d3_1);
lambda2 = 1-(th-d1)./(d2_1);
lambda3 = 1-(th-d2)./(d3_2);
...
idx2 = length(surface_x0.X) + size(v1,1) + [1:size(v2,1)]';
idx12 = length(surface_x0.X) + size(v1,1) + size(v2, 1) + [1:size(v1,1)]';
idx22 = length(surface_x0.X) + 2* size(v1,1) + size(v2, 1) + [1:size(v2,1)]';
...
surface_x1.X = [surface_x1.X(:); v1(:,1); v2(:,1) ; v1(:,1); v2(:,1)];
surface_x1.Y = [surface_x1.Y(:); v1(:,2); v2(:,2) ; v1(:,2); v2(:,2)];
surface_x1.Z = [surface_x1.Z(:); v1(:,3); v2(:,3) ; v1(:,3); v2(:,3)];

surface_x1.TRIV(t(i1),:) = [surface_x0.TRIV(t(i1),1) idx12(i1) idx22(i1)];
lt(t(i1)) = 1;

n0 = size(surface_x1.TRIV,1);
surface_x1.TRIV = [surface_x1.TRIV; [idx12(i2) idx22(i2) surface_x0.TRIV(t(i2),2)]];
surface_x1.TRIV = [surface_x1.TRIV; [idx12(i2) surface_x0.TRIV(t(i2),2) surface_x0.TRIV(t(i2),1)]];
surface_x1.TRIV = [surface_x1.TRIV; [idx12(i3) idx22(i3) surface_x0.TRIV(t(i3),3)]];
surface_x1.TRIV = [surface_x1.TRIV; [idx22(i3) surface_x0.TRIV(t(i3),1) surface_x0.TRIV(t(i3),3)]];
